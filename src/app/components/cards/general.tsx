...
const General = () => {
  ...
  const [contactEmail, setContactEmail] = useState('contact@hindsvaasthseva.com');
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">WhatsApp Integration</label>
            <button className="mt-1 px-4 py-2 bg-blue-500 text-white rounded-md">Connect WhatsApp Business API</button>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">Payment Gateway</label>
            <button className="mt-1 px-4 py-2 bg-green-500 text-white rounded-md">Configure payment methods</button>
          </div>
        </div>
      </div>
